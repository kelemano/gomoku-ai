...
public class Board {
        ...
        /**
         * Attempts to place a player's piece at the specified cell.
         * @param r Row index.
         * @param c Column index.
         * @param player The ID of the player making the move.
         * @return true if the move was successfully made; false if the cell is already occupied or out of bounds.
         */
        public boolean setCell(int r, int c, int player) {
            if (isValid(r, c) && grid[r][c] == EMPTY) {
                grid[r][c] = player;
                return true; // Move successfully placed
            }
            return false; // Cell is occupied or invalid
        }
